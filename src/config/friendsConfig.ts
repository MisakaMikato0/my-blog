...
export const friendsPageConfig: FriendsPageConfig = {
	...
	// 使用模板参数直接跳转到友链申请模板
	applyLink:
		"https://github.com/MisakaMikato0/my-blog/issues/new?template=friend-link.yml",

	// 本站信息，用于友链申请指南弹窗中的站点信息展示
	siteInfo: {
		name: "幽幽子的小站",
		desc: "幻想乡欢迎你。。。。。",
		url: "https://hakugyokurou.fun/",
		avatar: "https://hakugyokurou.fun/favicon/favicon.svg",
		email: "2301696346@qq.com",
	},
