...
<style>
	...
	.cranium {
		background:
			linear-gradient(180deg, #888 0 54%, #fff0 0 94%, #888 0 100%),
			radial-gradient(circle at 75% 69%, #fff0 0 0.21875rem, #888 calc(0.21875rem + 1px) 0.6058rem, #fff0 calc(0.6058rem + 1px) 100%),
			radial-gradient(circle at 25% 69%, #fff0 0 0.21875rem, #888 calc(0.21875rem + 1px) 0.6058rem, #fff0 calc(0.6058rem + 1px) 100%);
		width: 100%;
		height: 1.75rem;
		left: 0;
		top: 0;
	...
	.cranium:after {
		...
		left: 0.75rem;
		background:
			radial-gradient(circle at 90% 10%, #888 0 0.125rem, #fff0 calc(0.125rem + 1px) 100%),
			radial-gradient(circle at 10% 10%, #888 0 0.125rem, #fff0 calc(0.125rem + 1px) 100%);
	...
	.mouth {
		...
		top: 1.40625rem;
		background:
			radial-gradient(circle at 35% 98%, #888 0 0.08125rem, #fff0 calc(0.08125rem + 1px) 100%),
			radial-gradient(circle at 45% 100%, #888 0 0.08125rem, #fff0 calc(0.08125rem + 1px) 100%),
			radial-gradient(circle at 55% 100%, #888 0 0.08125rem, #fff0 calc(0.08125rem + 1px) 100%),
			radial-gradient(circle at 65% 98%, #888 0 0.08125rem, #fff0 calc(0.08125rem + 1px) 100%);
	...
	.hand {
		position: absolute;
		background:
			radial-gradient(circle at 91% 29%, #fff 0.0625rem, #fff0 calc(0.0625rem + 1px) 100%),
			radial-gradient(circle at 92% 49%, #fff 0.0625rem, #fff0 calc(0.0625rem + 1px) 100%),
			radial-gradient(circle at 91% 69%, #fff 0.0625rem, #fff0 calc(0.0625rem + 1px) 100%),
			radial-gradient(circle at 76% 21%, #fff 0.0625rem, #fff0 calc(0.0625rem + 1px) 100%),
			radial-gradient(circle at 78% 39%, #fff 0.0625rem, #fff0 calc(0.0625rem + 1px) 100%),
			radial-gradient(circle at 79% 58%, #fff 0.0625rem, #fff0 calc(0.0625rem + 1px) 100%),
			radial-gradient(circle at 78% 78%, #fff 0.0625rem, #fff0 calc(0.0625rem + 1px) 100%);
		width: 0.875rem;
		height: 0.625rem;
		left: -0.875rem;
		z-index: 0;
